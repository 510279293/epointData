<template>
  <div class="content-table">
    <epoint-table :data="data" :showIndex="true" :showItem="true" :config="ckBoxConfig" @sure="sureCkBox" :showSelection="true" :current-page="pagingConfig.page" :page-size="pagingConfig.size" @showTableDialog="showTableDialog">
      ...
      <el-table-column width="136" label="活动价" prop="salesQty"></el-table-column>
      ...
      <el-table-column width="136" sortable label="活动" prop="daySalesQty"></el-table-column>
      <el-table-column width="110" sortable label="库存" prop="daySalesQty"></el-table-column>
      <el-table-column width="110" sortable label="收藏商品数" prop="daySalesQty"></el-table-column>
      <el-table-column width="136" sortable label="店铺名称" prop="daySalesQty"></el-table-column>
      <el-table-column width="136" sortable label="旺旺号" prop="daySalesQty"></el-table-column>
      <el-table-column width="136" sortable label="所在省市" prop="daySalesQty"></el-table-column>
      <el-table-column width="110" sortable label="付款人数" prop="daySalesQty"></el-table-column>
      <el-table-column width="110" sortable label="所属类目" prop="daySalesQty"></el-table-column>
      <el-table-column width="136" sortable label="品牌名称" prop="daySalesQty"></el-table-column>
