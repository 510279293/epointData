  ...
  <div class="stolenManage">
    ...
    <div class="content-table">
      ...
      <epoint-table :data="data" :showIndex="true" :showItem="true" :config="ckBoxConfig" @sure="sureCkBox" :showSelection="false" :current-page="pagingConfig.page" :page-size="pagingConfig.size" @showTableDialog="showTableDialog">
        ...
        <el-table-column prop="prdimg" label="商品主图" width="90">
          <template slot-scope="scope">
            <img :src="scope.row.prdimg" style="width: 56px;height: 56px;">
          </template>
        </el-table-column>
        <el-table-column prop="prdimg" label="对比原图" width="90">
          <template slot-scope="scope">
            <img :src="scope.row.prdimg" style="width: 56px;height: 56px;">
          </template>
        </el-table-column>
        <el-table-column min-width="136" label="相似度" prop="totalSalesQty"></el-table-column>
        <el-table-column min-width="136" label="低价区间" prop="totalSalesQty"></el-table-column>
        <el-table-column min-width="136" sortable label="抓取时间" prop="salesQty"></el-table-column>
        <el-table-column min-width="110" label="计划名称" prop="daySalesQty"></el-table-column>
        <el-table-column min-width="150" label="店铺名称" prop="daySalesQty"></el-table-column>
        <el-table-column min-width="136" label="旺旺号" prop="salesQty"></el-table-column>
        <el-table-column min-width="110" label="所在省市" prop="daySalesQty"></el-table-column>
        <el-table-column min-width="150" label="店铺等级" prop="daySalesQty"></el-table-column>
